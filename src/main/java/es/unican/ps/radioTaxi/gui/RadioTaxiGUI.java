package es.unican.ps.radioTaxi.gui;
...
import es.unican.ps.radioTaxi.ServicioTaxi;
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				inicio.set(Calendar.HOUR_OF_DAY,
						(Integer) horaInicio.getValue());
				...
				ServicioTaxi s = new ServicioTaxi(inicio, fin, kilometros,
						urbano.isSelected(), aeropuerto.isSelected());
