...
public class ServicioTaxi {
	...
	public ServicioTaxi(Calendar horaInicio, Calendar horaFin, double kms,
			boolean urbano, boolean aeropuerto) throws ValorNoValidoException {
	...
	public double importeServicio() {
		...
		importe = TarifasRadioTaxi.bajadaBandera(tarifa) + getKms()
				* TarifasRadioTaxi.precioPorKm(tarifa);
