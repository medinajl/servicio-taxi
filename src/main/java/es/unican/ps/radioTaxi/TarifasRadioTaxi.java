package es.unican.ps.radioTaxi;

import java.util.HashMap;
import java.util.Map;

/**
 * Clase que agrupa las tarifas del servicio de RadioTaxi de Santander Modo de
 * uso: Es necesario invocar el m�todo inicializa() al menos una vez antes de
 * usar los m�todos de consulta
 * 
 * @author IS2
 * 
 */
public class TarifasRadioTaxi {
	...
	/**
	 * Retorna el valor de servicio m�nimo para la tarifa dada
	 * 
	 * @param tarifa
	 * @return
	 */
